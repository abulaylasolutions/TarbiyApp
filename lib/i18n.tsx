...
const translations: Record<Language, Record<string, string>> = {
  it: {
    ...
    forgotPasswordMsg: 'Per recuperare la password contatta il supporto: tarbiyapp@gmail.com',
    syncData: 'Aggiorna dati',
    syncSuccess: 'Dati aggiornati',
  ...
  en: {
    ...
    forgotPasswordMsg: 'To recover your password please contact support: tarbiyapp@gmail.com',
    syncData: 'Refresh Data',
    syncSuccess: 'Data refreshed',
  ...
  ar: {
    ...
    forgotPasswordMsg: 'للاسترداد يرجى التواصل مع الدعم: tarbiyapp@gmail.com',
