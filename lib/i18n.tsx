...
const translations: Record<Language, Record<string, string>> = {
  it: {
    ...
    premium: 'Premium',
    free: 'Gratuito',
    hijriCalendar: 'Calendario islamico (Hijri)',
    hijriOn: 'Islamico',
    hijriOff: 'Solare',
    info: 'Info',
    privacy: 'Privacy',
    ...
    premiumUnlock: 'Sblocca tutte le funzionalita avanzate',
    premiumTrial: '7 giorni di prova gratuita',
    premiumFeat1: 'Figli illimitati da monitorare',
    premiumFeat2: 'Dashboard dettagliata per ogni figlio',
    premiumFeat3: 'Sincronizzazione completa tra genitori',
    premiumFeat4: 'Personalizzazione colori e temi',
    premiumFeat5: 'Tutte le funzioni future incluse',
    premiumActivated: 'Premium attivato!',
    premiumMonthlyMsg: 'Grazie! Abbonamento mensile attivato (demo).',
    premiumAnnualMsg: 'Grazie! Risparmi il 17% con il piano annuale (demo).',
    premiumLifetimeMsg: 'Grazie! Accesso a vita sbloccato (demo).',
    monthly: 'Mensile',
    annual: 'Annuale',
    lifetime: 'A vita',
    month: 'mese',
    ...
    buy: 'Acquista',
    premiumBlockBacheca: 'Sblocca la Bacheca con Premium per condividere note con il cogenitore',
    premiumBlockChildren: 'Passa a Premium per figli illimitati',
    premiumBlockEvents: 'Premium richiesto per aggiungere eventi personalizzati',
    premiumBlockPairing: 'Premium richiesto per sincronizzare con cogenitore',
    premiumBlockQuran: 'Sblocca con Premium per memorizzare le Sure',
  ...
  en: {
    ...
    premiumUnlock: 'Unlock all advanced features',
    premiumTrial: '7-day free trial',
    premiumFeat1: 'Unlimited children to track',
    premiumFeat2: 'Detailed dashboard for each child',
    premiumFeat3: 'Full sync between parents',
    premiumFeat4: 'Color and theme customization',
    premiumFeat5: 'All future features included',
    premiumActivated: 'Premium activated!',
    premiumMonthlyMsg: 'Thank you! Monthly subscription activated (demo).',
    premiumAnnualMsg: 'Thank you! You save 17% with the annual plan (demo).',
    premiumLifetimeMsg: 'Thank you! Lifetime access unlocked (demo).',
    monthly: 'Monthly',
    annual: 'Annual',
    lifetime: 'Lifetime',
    month: 'month',
    ...
    buy: 'Buy',
    premiumBlockBacheca: 'Unlock the Board with Premium to share notes with your co-parent',
    premiumBlockChildren: 'Upgrade to Premium for unlimited children',
    premiumBlockEvents: 'Premium required to add custom events',
    premiumBlockPairing: 'Premium required to sync with co-parent',
    premiumBlockQuran: 'Unlock with Premium to memorize Surahs',
  ...
  ar: {
    ...
    premiumUnlock: 'افتح جميع الميزات المتقدمة',
    premiumTrial: '7 أيام تجربة مجانية',
    premiumFeat1: 'أطفال غير محدودين للمتابعة',
    premiumFeat2: 'لوحة تحكم مفصلة لكل طفل',
    premiumFeat3: 'مزامنة كاملة بين الوالدين',
    premiumFeat4: 'تخصيص الألوان والسمات',
    premiumFeat5: 'جميع الميزات المستقبلية مشمولة',
    premiumActivated: 'تم تفعيل المميز!',
    premiumMonthlyMsg: 'شكراً! تم تفعيل الاشتراك الشهري (تجريبي).',
    premiumAnnualMsg: 'شكراً! توفر 17% مع الخطة السنوية (تجريبي).',
    premiumLifetimeMsg: 'شكراً! تم فتح الوصول مدى الحياة (تجريبي).',
    monthly: 'شهري',
    annual: 'سنوي',
    lifetime: 'مدى الحياة',
    month: 'شهر',
    ...
    buy: 'شراء',
    premiumBlockBacheca: 'افتح اللوحة مع المميز لمشاركة الملاحظات مع الشريك',
    premiumBlockChildren: 'قم بالترقية للحصول على أطفال غير محدودين',
    premiumBlockEvents: 'المميز مطلوب لإضافة أحداث مخصصة',
    premiumBlockPairing: 'المميز مطلوب للمزامنة مع الشريك',
    premiumBlockQuran: 'افتح مع المميز لحفظ السور',
